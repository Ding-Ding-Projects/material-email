...
const preferences: Preferences = { language: "bilingual", funnyEnglish: 5, funnyCantonese: 4, theme: "dark", density: "relaxed", accent: "#123456", fontFamily: "Arial", fontScale: 1.5, fontWeight: 700, narratorEnabled: true, narratorLanguage: "yue", nativeNotificationsEnabled: true, historyRetentionDays: 730, selectedAccountId: "acct", selectedFolderPath: "Inbox" };
