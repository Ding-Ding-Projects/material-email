...
| Real-Electron coverage | Previously recorded full suite: 15 / 15; focused remote-content consent/restart and bilingual scenarios: 2 / 2; focused workspace-tab accessibility scenario: 1 / 1. The expanded full suite was not rerun in this pass. |
