...
const checks = [
  ...
  ["installer status keeps isolated-profile evidence separate from stronger Windows claims", js.includes("absent isolated-profile defaults") && js.includes("default Windows profile") && js.includes("interactive first launch") && js.includes("Authenticode proof")],
