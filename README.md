...
- manual IMAP and SMTP settings, bounded local hostname/certificate-identity and TLS/port preflight, connection tests, account persistence, folder/message synchronization, message reading, read/star flags, moving, sending, and local draft storage;
