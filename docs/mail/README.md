...
| [Reading and message safety](reading-and-message-safety.md) | Parser and per-message remote-image consent verified locally | MIME parsing, sanitized display data, host summary, and default-deny image loading |
