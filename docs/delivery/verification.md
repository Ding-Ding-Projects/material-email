...
| Tests | `npm test` | 36 files / 178 tests passed in the final local gate, including bounded MIME, remote-content sanitizer, persistence, IPC, and CSP assertions | Repeat in CI |
