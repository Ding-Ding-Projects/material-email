...
| Tests | `npm test` | 56 files / 308 tests passed in the final local gate, including Outbox restart recovery, installer profile/claim guards, bounded MIME, remote-content sanitizer, history retention/deletion evidence, persistence, IPC, and CSP assertions | Repeat in CI |
