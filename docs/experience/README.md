...
| [Search and regex builder](search-and-regex-builder.md) | Global Settings and Tab Manager discovery restart/focus verified; nested surface matrix open | Plain search, regex dialect, bounds, persistence, and builder requirements |
| [Tabs and discovery](tabs-and-discovery.md) | Tab-strip and four discovery-search slices verified; final interaction audit open | Tab behavior, search scopes, and bulk close |
