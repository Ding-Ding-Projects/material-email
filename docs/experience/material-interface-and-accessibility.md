...
**Renderer integrated with focused Electron accessibility verification.** Dirty-state decisions, modal focus containment/return, workspace-tab roving focus, named caption controls, saved window placement, load errors, representative bilingual semantics, reduced-motion timing, and collision-safe focused popovers pass; full visual and assistive-technology matrices remain open.
