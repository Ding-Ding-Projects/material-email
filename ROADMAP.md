...
- [x] Run the consolidated type, unit, integration, and build verification (`npm run check`: 60 files / 326 tests on the current tree; focused Tab Manager discovery and Settings search each passed 1 / 1 real-Electron restart scenario, cached-mail search passed 3 / 3, forced-colors/focus passed 2 / 2, focused Outbox redaction/recovery passed 1 / 1, responsive/accessibility passed 2 / 2, Windows window controls passed 3 / 3, and broader evidence remains listed in `HANDOFF.md`)
